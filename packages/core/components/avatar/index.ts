...
import WithText, { type AvatarWithTextProps } from '$/core/components/avatar/avatar-with-text';
import { type AvatarProps, AvatarSize } from '$/core/components/avatar/utils';

export type { AvatarProps, AvatarStackProps, AvatarUserProps, AvatarWithTextProps };

export { AvatarSize };

export const Avatar = Object.assign(BaseAvatar, { Stack, User, WithText });
